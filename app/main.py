...
# Simple in-memory cache for leaderboard to reduce DB queries
...
def leaderboard():
    ...
    if _leaderboard_cache is not None and (current_time - _leaderboard_cache_time) < CACHE_TTL:
        ...
        try:
            ...
            _leaderboard_cache_time = current_time
